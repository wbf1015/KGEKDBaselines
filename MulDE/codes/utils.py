...
def parse_args(args=None):
    ...
    parser.add_argument('-hidden_dim', '--hidden_dim', default=500, type=int)
    ...
    parser.add_argument('-dropout', '--dropout', default=0.0001, type=float)
    ...
    parser.add_argument('-pretrain_path1', '--pretrain_path1', type=str, default='without', help='pretrained model path')
    parser.add_argument('-pretrain_path2', '--pretrain_path2', type=str, default='without', help='pretrained model path')
    parser.add_argument('-pretrain_path3', '--pretrain_path3', type=str, default='without', help='pretrained model path')
    parser.add_argument('-pretrain_path4', '--pretrain_path4', type=str, default='without', help='pretrained model path')
    parser.add_argument('-save_checkpoint_steps', '--save_checkpoint_steps', default=10000, type=int)
    ...
    parser.add_argument('-soft_loss_weight', '--soft_loss_weight', default=0.1, type=float)
    parser.add_argument('-k', '--k', default=200, type=int)
    parser.add_argument('-teacher_num', '--teacher_num', default=4, type=int)
